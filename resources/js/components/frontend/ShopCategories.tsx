...
//   }, []);
  ...
  return (
    <div className="w-full bg-gradient-to-b from-amber-50/70 to-amber-50/30 py-8 px-4 md:px-8 relative border-y border-amber-100/50">
                ...
                >
                  ...
                  >
                    <div className="relative w-full h-full rounded-full overflow-hidden bg-white flex items-center justify-center">
                      <div className=" inset-0 bg-gradient-to-b from-white/0 via-white/0 to-black/10"></div>
                      <img
                        src={category.image}
                        alt={category.name}
