        ...
        <>
            <nav className='w-full flex flex-col justify-center items-center relative'>
                ...
                <div className={`w-full px-[5%] lg:px-[12%] py-6 flex justify-between items-center gap-6 transition-all duration-500 ${menuOpen ? 'h-auto' : ''}`}>
                    ...
                    <ul className='flex gap-6 w-2/5 nav-menu font-bold'>
                        <li><Link href="/" className='hover:text-yellow-500 text-lg transition'>Accueil</Link></li>
                        <li><Link href="/about" className='hover:text-yellow-500 text-lg transition'>Apropos</Link></li>
                        <li><Link href="/shop" className='hover:text-yellow-500 text-lg transition'>Boutique</Link></li>
                        <li><Link href="/blog" className='hover:text-yellow-500 text-lg transition'>Blog</Link></li>
                        <li><Link href="/faq" className='hover:text-yellow-500 text-lg transition'>Faq's</Link></li>
                        <li><Link href="/contact" className='hover:text-yellow-500 text-lg transition'>Contact</Link></li>
                    </ul>
